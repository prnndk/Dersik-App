...
<section class="bg-gray-200 min-h-screen flex items-center justify-center p-5">
    ...
    <form class="space-y-6" autocomplete="off" id="form">
        ...
        <div class="flex">
                <div class="flex items-center h-5">
                    <input id="teman_smasa" aria-describedby="teman_smasa-text" type="checkbox" value="Tidak Ada" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                </div>
                <div class="ml-2 text-sm">
                    <label for="teman_smasa" class="font-medium text-gray-900 dark:text-gray-300">Teman SMASA satu domisili</label>
                    <p id="teman_smasa-text" class="text-xs font-normal text-gray-500 dark:text-gray-300">Centang pilihan disamping jika ada, jika tidak ada biarkan saja</p>
                </div>
        </div>
        <div id="block_banyak_teman">
            <label for="banyak_teman" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Banyak Teman Yang Ada</label>
            <input type="number" name="banyak_teman" id="banyak_teman" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Banyaknya" value="{{ old('input_manual') }}">
        </div>
        <button type="button" id="submit" class="w-full bg-blue-500 text-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit pendataan!</button>
